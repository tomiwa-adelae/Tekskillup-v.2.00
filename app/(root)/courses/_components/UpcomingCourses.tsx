...
// import { upcomingCourses } from "@/constants";
...
// 				{upcomingCourses.map(
// 					({ image, title, price, startDate }, index) => (
// 						<div key={index} className="border border-bg-300 p-4">
// 							<Image
// 								src={image}
// 								alt={title}
// 								width={1000}
...
// 							<TypingSubText
// 								title={title}
// 								textStyles="text-center text-base font-bold"
// 							/>
//
// 							<div>
